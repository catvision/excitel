...
CREATE TABLE IF NOT EXISTS `plans` (
  ...
  `_id` char(24) NOT NULL DEFAULT '0' COMMENT 'From mokup data generated and used function I presume is MongoDB function which returns always 24 chars. Avoid VARCHAR with unique index',
  `guid` char(36) NOT NULL DEFAULT '0',
  `name` varchar(100) NOT NULL DEFAULT '0',
  `plan_status` enum('Active','Inactive') NOT NULL DEFAULT 'Active',
  `price` decimal(6,2) NOT NULL DEFAULT (0),
  `plan_type` enum('Lan','Fiber') NOT NULL DEFAULT 'Lan',
  `category` enum('Weekly','Monthly','Quarterly') NOT NULL DEFAULT 'Weekly',
  ...
  KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='contains internet plans list';
